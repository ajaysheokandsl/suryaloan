...
import instant_loan from "../images/instant_loan.jpg";
        ...
        <div className="content_page_banner_wrapper">
          ...
          <div className="text_content_wrapper">
            <div className="text_content">
              ...
              <p>
                At SuryaLoan, we understand that urgent financial needs can arise
              ...
              <br />
              <p>
              At SuryaLoan, we are committed to providing instant loan urgent solutions that cater to your specific needs. Whether you're dealing with an unexpected expense or need extra cash quickly, our instant loan options offer the flexibility and speed you require. Trust SuryaLoan for reliable and fast financial support, and experience the convenience of our small instant loans and instant personal loans online today.
              </p>
              <br />
