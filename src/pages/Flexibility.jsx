...
import service_three from "../images/services_three.jpg";
        ...
        <div className="content_page_banner_wrapper">
          ...
          <div className="text_content_wrapper">
            <div className="text_content">
              ...
              <p>
                At SuryaLoan, we focus on meeting your financial needs by
                ...
                assist, SuryaLoan ensures a loan experience that adapts to
                your specific needs.
              </p>
              <br />
              <p>
                In addition to our flexible loan services, SuryaLoan stands
                ...
                decisions and manage your loan effectively. At SuryaLoan, we
