          ...
          <div className="text_content" style={{ width: "95%" }}>
            ...
            <div className="flex flex-center space-evenly content_row">
              <div className="content_item" style={{ maxWidth: "90%" }}>
                ...
                <span>
                  At SuryaLoan, we strive to offer transparent and
                ...
                <p className="light_color">
                  <ul>
                    ...
                    <li>
                      <b>Prepayment Penalties:</b> At SuryaLoan, we do not
            ...
            <div className="flex flex-center space-evenly content_row">
              <div className="content_item" style={{ maxWidth: "90%" }}>
                <h2 className="mb10">Why Choose SuryaLoan</h2>
                <p className="light_color">
                  <ul>
                    <li>
            ...
            <div className="flex flex-center space-evenly content_row">
              <div className="content_item" style={{ maxWidth: "90%" }}>
                ...
                <table className="representative-example-table">
                  <tbody>
                    <td>
                      <tr>Loan Amount</tr>
                      <tr>₹50,000</tr>
                    ...
                    <td>
                      <tr>Processing Fee</tr>
                      <tr>₹1,000</tr>
                    </td>
                    <td>
                      <tr>GST on Processing Fee</tr>
                      <tr>₹180</tr>
                    </td>
                    <td>
                      <tr>Amount Disbursed</tr>
                      <tr>₹48,820</tr>
                    </td>
                    <td>
                      <tr>EMI</tr>
                ...
                <p className="light_color">
                  <ul>
                    ...
                    <li>GST on Processing Fee: ₹360</li>
                    <li>Disbursed Amount: ₹97,640 (₹1,00,000 - (₹2,000 + ₹360))</li>
                    <li>Monthly EMI: ₹10,688</li>
                    <li>Total Interest Payable Over the Loan Term: ₹28,261</li>
                    <li>
                      Total Amount Repayable: ₹1,28,261 (Principal + Interest)
                    </li>
                    <li>APR: 35%</li>
                  </ul>
                </p>
                ...
                <p className="light_color">
                  <ul>
                    ...
                    <li>
                      <b>GST on Processing Fee:</b> A GST on processing fee of
                      loan, which is 18% of the Processing Fee. This fee is deducted
                      from the disbursed amount.
                    </li>
                    <li>
                      <b>Disbursed Amount:</b> The amount you receive after the
                      origination fee and gst fee is deducted, which is ₹97,640.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      pay over the loan term, which is ₹28,261.
                    </li>
                    <li>
                ...
                <p className="mt6">
                  ...
                  with a typical loan from SuryaLoan. Your actual rates and
